(function () {
  ...
  function q(a, b, c) {
    function d(a) {
      var d;
      if (h.composed && "function" == typeof a.composedPath) for (var e = a.composedPath(), f = 0, F; F = e[f]; f++) 1 == F.nodeType && ja(F, b) && (d = F);else a: {
        if ((d = a.target) && 1 == d.nodeType && b) for (d = [d].concat(la(d)), e = 0; f = d[e]; e++) if (ja(f, b)) {
          d = f;
          break a;
        }
        d = void 0;
...
saviomd.header = function () {
  ...
  */
  $('.js-btn-nav').on('click', function (e) {
    e.preventDefault();
    $(_this).siblings('ul').toggleClass('active');
  });
  /*
  Animacao p/ scroll
  ====================
