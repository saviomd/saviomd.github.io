      ...
      <Container>
        <div className="mx-auto bg-avatar bg-[right_-20px] bg-no-repeat pb-4 pt-32 sm:pt-4 sm:pr-[130px] md:w-10/12 lg:w-8/12">
          ...
          <div className="animate__animated animate__delay-1s animate__fadeInRight relative rounded-lg bg-layer-1-light p-4 text-xl dark:bg-layer-1-dark">
            ...
            <span className="absolute -top-[30px] right-28 border-[15px] border-transparent border-b-layer-1-light dark:border-b-layer-1-dark sm:top-[20px] sm:-right-[30px] sm:border-l-layer-1-light sm:border-b-transparent dark:sm:border-l-layer-1-dark" />
          </div>
        </div>
      </Container>
    </Section>
